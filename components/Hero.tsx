...
export default function Hero() {
    ...
    return (
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
                ...
                <div className="max-w-5xl mx-auto">
                    ...
                    <div className="backdrop-blur-xl bg-white/10 rounded-3xl p-8 md:p-16 shadow-2xl border border-white/20 transform hover:scale-[1.02] transition-transform duration-500">
                        ...
                        <h1 className="text-4xl md:text-7xl font-black leading-tight mb-6 text-center">
                            <span className="bg-gradient-to-r from-white via-blue-100 to-purple-100 bg-clip-text text-transparent animate-gradient-x drop-shadow-2xl">
                                Wujudkan Impian Ibadah
                            </span>
                            <br />
                            <span className="bg-gradient-to-r from-purple-100 via-pink-100 to-white bg-clip-text text-transparent animate-gradient-x-reverse drop-shadow-2xl">
                                ke Tanah Suci
                            </span>
                        </h1>
                        ...
                        <p className="text-lg md:text-2xl text-white/90 max-w-3xl mx-auto text-center mb-8 leading-relaxed font-light">
                            ...
                            <span className="font-semibold text-yellow-300">nyaman</span>,{" "}
                            <span className="font-semibold text-blue-300">aman</span>, dan{" "}
                            <span className="font-semibold text-purple-300">terjangkau</span>{" "}
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                            <Link href="#paket" className="w-full sm:w-auto">
                                <Button
                                    size="lg"
                                    className="w-full sm:w-auto text-lg px-10 py-7 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 shadow-2xl shadow-blue-500/50 hover:shadow-blue-600/60 transition-all duration-300 hover:scale-105 font-bold rounded-xl border-2 border-white/20"
                                >
                            ...
                            <Button
                                variant="outline"
                                size="lg"
                                className="w-full sm:w-auto text-lg px-10 py-7 bg-white/10 backdrop-blur-md text-white border-2 border-white/40 hover:bg-white hover:text-purple-600 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 font-bold rounded-xl group"
            ...
            <div className="absolute -bottom-32 -left-32 w-96 h-96 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full blur-3xl opacity-20 animate-pulse-slow"></div>
